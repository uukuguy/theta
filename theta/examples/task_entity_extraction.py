...
from theta.nlp.entity_extraction.dataset import NerDataset, get_default_tokenizer
from theta.nlp.entity_extraction.runner import (
    run_training,
    run_evaluating,
    run_predicting,
)
...
def main(args):
    if args.do_train:
        ...
        run_training(args, ner_labels, train_dataset, val_dataset, bert_model_path)
    ...
    if args.do_eval:
        ...
        run_evaluating(args, ner_labels, val_dataset, bert_model_path)
