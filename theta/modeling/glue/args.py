...
def get_args(special_args: list = None):
    ...
    parser.add_argument(
        ...
        help="Available losses ['CrossEntropyLoss', 'FocalLoss', 'CircleLoss']"
    )
    parser.add_argument("--focalloss_gamma", default=1.5)
    parser.add_argument("--focalloss_alpha", default=None)
