...
#  from swin_optimizer import DistOptimizerHook
...
def main():
    ...
    pretrained_model_name = os.path.splitext(os.path.basename(config_file))[0]
    ...
    if args.work_dir is not None:
        ...
        cfg.work_dir = osp.join('./work_dirs', pretrained_model_name, "latest")
