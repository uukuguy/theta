...
from .modeling import encode_text
from .modeling import build_model, Evaluator, evaluate, Model  # , collate_fn
...
def run_evaluating(args, entity_labels, relation_labels, val_dataset, bert_model_path):
    ...
    eval_result = evaluate(
        model, val_dataloader, entities_id2label, relations_id2label, threshold=0
    )
